 ...
 * OAUTHADMIN_UNAUTHORIZED_USER_HANDLER: Callable that receives request object, OAuth token
   and exception. This callable should return proper response object for unauthorized users.
